...
var Perser = /** @class */ (function () {
    function Perser(file) {
        this.file = file;
        this.stream = fs_1.createReadStream(file, {
            encoding: 'utf-8',
            highWaterMark: 256
        });
    ...
    Perser.prototype.advance = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                // console.log(this.hasMoreCommands())
                if (!this.hasMoreCommands())
                    return [2 /*return*/];
                chunk = '';
                buff = fs_1.readFileSync(this.file, { encoding: 'ascii' });
...
var perser = new Perser('06/add/Add.asm');
perser.advance();
